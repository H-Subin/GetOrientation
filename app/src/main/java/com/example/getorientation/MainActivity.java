...
public class MainActivity extends AppCompatActivity {
    TextView textAzimuth, textPitch, textRoll;
        ...
        listener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                if (magValues != null && accValues != null) {
                    ...
                    textAzimuth.setText("Azimuth: " + (int) radian2Degree(values[0]));
                    textPitch.setText("Pitch: " + (int) radian2Degree(values[1]));
                    textRoll.setText("Roll: " + (int) radian2Degree(values[2]));
                }
            }
